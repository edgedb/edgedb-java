...
import com.edgedb.*;
import com.edgedb.async.ExceptionallyCompose;
import com.edgedb.binary.PacketReader;
import com.edgedb.binary.builders.CodecBuilder;
import com.edgedb.binary.builders.ObjectBuilder;
import com.edgedb.binary.builders.types.TypeBuilder;
import com.edgedb.binary.codecs.ArgumentCodec;
...
import com.edgedb.binary.packets.receivable.*;
import com.edgedb.binary.packets.sendables.ClientHandshake;
import com.edgedb.binary.packets.sendables.Execute;
import com.edgedb.binary.packets.sendables.Parse;
import com.edgedb.binary.packets.shared.*;
import com.edgedb.datatypes.Json;
import com.edgedb.binary.duplexers.Duplexer;
import com.edgedb.util.Scram;
import com.edgedb.exceptions.*;
    ...
    protected final CompletionStage<Void> executeQuery(
        ...
        return CompletableFuture.runAsync(() -> {
                ...
                .thenCompose((v) -> {
                    ...
                    return ExceptionallyCompose.exceptionallyCompose(task, e -> {
