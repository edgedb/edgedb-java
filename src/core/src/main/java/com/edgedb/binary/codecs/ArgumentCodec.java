...
public interface ArgumentCodec<T> extends Codec<T> {
    ...
    static <T> ByteBuf serializeToBuffer(ArgumentCodec<T> codec, final @Nullable Map<String, ?> value, final CodecContext context) throws OperationNotSupportedException, EdgeDBException {
