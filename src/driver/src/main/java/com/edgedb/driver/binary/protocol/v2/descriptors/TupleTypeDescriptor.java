...
public final class TupleTypeDescriptor implements TypeDescriptor, MetadataDescriptor {
    public final UUID id;
    public final String name;
    public final boolean isSchemaDefined;
    public final UShort[] ancestors;
    public final UShort[] elements;

    public TupleTypeDescriptor(UUID id, PacketReader reader) {
        this.id = id;
        ...
        this.elements = reader.readArrayOf(UShort.class, PacketReader::readUInt16, UShort.class);
    }
