...
public final class GetUserLikedPostsResult {
  ...
  @EdgeDBName("author")
  private final GetUserLikedPostsResultAuthor author;

  @EdgeDBName("created_at")
  private final @Nullable OffsetDateTime createdAt;

  @EdgeDBDeserializer
  public GetUserLikedPostsResult(@EdgeDBName("id") UUID id, @EdgeDBName("title") String title,
      @EdgeDBName("content") String content,
      @EdgeDBName("author") GetUserLikedPostsResultAuthor author,
  ...
  public GetUserLikedPostsResultAuthor getAuthor() {
    return this.author;
  }
