...
public final class GetUserLikedPostsPost implements Post {
  ...
  @EdgeDBDeserializer
  public GetUserLikedPostsPost(@EdgeDBName("createdAt") @Nullable OffsetDateTime createdAt,
      @EdgeDBName("id") UUID id, @EdgeDBName("author") GetUserLikedPostsUser author,
